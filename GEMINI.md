...
## Recent Changes
- 001-gh-cli-integration: Added Python >= 3.12 + Google Agent Development Kit (ADK), Pydantic, LangSmith, tenacity
- 001-seccure-migration: Added Python >= 3.12 + Google Agent Development Kit (ADK), Pydantic, LangSmith, pinecone-client

- 001-seccure-migration: Added Python >= 3.12 + Google Agent Development Kit (ADK), Pydantic, LangSmith
