...
async def list_dependabot_alerts(ctx: ToolContext) -> str:
    ...
    """
    raise SystemExit("Unsupported error: No direct equivalent tool in github-mcp-server for dependabot alerts")
...
async def list_code_scanning_alerts(ctx: ToolContext) -> str:
    ...
    """
    raise SystemExit("Unsupported error: No direct equivalent tool in github-mcp-server for code scanning alerts")
